...
| Opción    | Descripción                                                                                                                                                      |
|----------------------|--------------------------------------------------|
| `default` | Utilice el método S3 predeterminado para el marco de datos.                                                                                                      |
| `kable`   | Tabla de markdown usando la función [`knit::kable()`](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html).                                                 |
| `tibble`  | Tabla de texto plano usando el paquete [`tibble`](https://tibble.tidyverse.org/).                                                                                |
| `paged`   | Tabla HTML con paginación para filas y columnas (implementado usando [rmarkdown::paged_table()](https://pkgs.rstudio.com/rmarkdown/reference/paged_table.html)). |
...
Guarde su documento e verifique la salida renderizada. La expresión dentro de los acentos graves se ha ejecutado y la oración incluye el número real de observaciones.
